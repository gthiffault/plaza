...
?>
	...
	<footer class="c-footer">
		...
		<section class="o-section c-footer_content">
			<div class="o-wrapper">
				<div class="o-layout">
					<div class="o-layout__item u-1/3@portrait-large-tablet u-1/2@portrait-small-tablet"><p class="c-footer_title">Visit us</p>
						<p><?php echo get_field('optAddressFooter','option');?></p>
					</div>
					<div class="o-layout__item u-1/3@portrait-large-tablet u-1/2@portrait-small-tablet"><p class="c-footer_title">Follow us</p>
					...
					<div class="o-layout__item c-coordonates u-1/3@portrait-large-tablet u-1/2@portrait-small-tablet">
		...
		<section class="o-section c-footer_copyright">
			<div class="o-wrapper">
<small>© <?php echo date('Y');?> <?php echo __('All rights reserved','plaza');?> - Hôtel plaza - <?php echo __('Project signed Zel','plaza');?></small>
			</div>			
		</section>		
	</footer><!-- #colophon -->
